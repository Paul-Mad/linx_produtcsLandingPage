...
const listProducts = async () => {
  try {
    ...
    products.forEach(({description, id, image, installments, name, oldPrice, price}) => productsList.insertAdjacentHTML("beforeend", `
  <div class="product">
...
},{"./validation.helper":"XKE9k","./firebase":"6lkjF"}],"XKE9k":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "validateCpf", function () {
  return validateCpf;
});
...
},{}],"6lkjF":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "setData", function () {
  return setData;
});
...
},{"firebase/app":"6wFrx","firebase/firestore":"5Eq2v","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6wFrx":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
_parcelHelpers.export(exports, "extractQuerystring", function () {
  return extractQuerystring;
});
_parcelHelpers.export(exports, "getModularInstance", function () {
...
},{"tslib":"4rd38","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5qT0x":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
  ...
  */
  ...
  Provider.prototype.initialize = function (opts) {
    ...
    try {
      ...
      for (var _d = _tslib.__values(this.instancesDeferred.entries()), _e = _d.next(); !_e.done; _e = _d.next()) {
...
},{}],"5Eq2v":[function(require,module,exports) {
'use strict';
...
},{"@firebase/app":"6IUA5","@firebase/util":"3bR6t","@firebase/logger":"5PuYX","@firebase/webchannel-wrapper":"71Sz5","tslib":"4rd38","./prebuilt-ac190846-5fb4dac2.js":"4Yeaj","@firebase/component":"5qT0x","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"71Sz5":[function(require,module,exports) {
var global = arguments[3];
(function () {
  /*
...
},{}],"4Yeaj":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "$", function () {
  return wc;
});
...
_parcelHelpers.export(exports, "_", function () {
  return ea;
});
...
_parcelHelpers.export(exports, "m", function () {
  return na;
});
_parcelHelpers.export(exports, "n", function () {
  return Vc;
});
_parcelHelpers.export(exports, "q", function () {
  return Ec;
...
function N(t) {
  ...
  if (S.logLevel <= _firebaseLogger.LogLevel.DEBUG) {
    var r = e.map(x);
...
function A(t) {
  for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
  if (S.logLevel <= _firebaseLogger.LogLevel.ERROR) {
    var r = e.map(x);
...
function k(t) {
  for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
  if (S.logLevel <= _firebaseLogger.LogLevel.WARN) {
    var r = e.map(x);
...
(function (t) {
  ...
  return (_tslib.__extends(e, t), e.prototype.construct = function (t, n, r) {
    return new e(t, n, r);
...
function dt(t) {
  ...
  })(t.timestampValue) : ("stringValue" in t) ? t.stringValue : ("bytesValue" in t) ? Z(t.bytesValue).toBase64() : ("referenceValue" in t) ? (n = t.referenceValue, st.fromName(n).toString()) : ("geoPointValue" in t) ? "geo(" + (e = t.geoPointValue).latitude + "," + e.longitude + ")" : ("arrayValue" in t) ? (function (t) {
...
function $t(t) {
  ...
  if (null === e.p) {
    ...
    (n.isKeyField() || e.p.push(new qt(n)), e.p.push(new qt(W.keyField(), "asc"))); else {
...
function Jt(t) {
  var e = O(t);
  if (!e.T) if ("F" === /*First*/
  e.limitType) e.T = Tt(e.path, e.collectionGroup, $t(e), e.filters, e.limit, e.startAt, e.endAt); else {
    for (var n = [], r = 0, i = $t(e); r < i.length; r++) {
...
function ne(t) {
  return "Query(target=" + (function (t) {
    ...
    return (null !== t.collectionGroup && (e += " collectionGroup=" + t.collectionGroup), t.filters.length > 0 && (e += ", filters: [" + t.filters.map(function (t) {
      ...
      var e;
    }).join(", ") + "]"), rt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map(function (t) {
      return (function (t) {
        return t.field.canonicalString() + " (" + t.dir + ")";
      })(t);
    ...
    return _tslib.__awaiter(this, void 0, void 0, function () {
      ...
      return _tslib.__generator(this, function (r) {
        switch (r.label) {
          ...
          case 2:
            return [2, /*return*/
            (this.bt && (this.db.onversionchange = function (t) {
              return n.bt(t);
            }), this.db)];
        }
      });
              ...
              return _tslib.__generator(this, function (f) {
                switch (f.label) {
                  ...
                  case 2:
                    ...
                    }).toPromise(), a = {}, s.catch(function () {}), [4, /*yield*/
                    e.dt]);
                  case 3:
                    return [2, /*return*/
...
function Ur(t) {
  ...
  return (void 0 !== t.query.documents ? (R(1 === (n = t.query).documents.length), e = Jt(Qt(Dn(n.documents[0])))) : e = (function (t) {
    return Jt(Pn(t));
...
(function () {
  ...
  return (t.prototype.calculateTargetCount = function (t, e) {
    ...
    var n = this;
    return -1 === this.params.cacheSizeCollectionThreshold ? (N("LruGarbageCollector", "Garbage collection skipped; disabled"), mr.resolve(Xr)) : this.getCacheSize(t).next(function (r) {
...
(function (t) {
  ...
  */
  ...
  return (_tslib.__extends(e, t), e.prototype.applyChanges = function (t) {
...
(function () {
  ...
  */
  h) {
    ...
    (this.referenceDelegate = new yi(this, i), this.Le = n + "main", this.R = new Rr(a), this.Be = new wr(this.Le, 11, new Ti(this.R)), this.qe = new si(this.referenceDelegate, this.R), this.Ut = new Hr(), this.Ue = (function (t, e) {
      return new wi(t, e);
      ...
      return _tslib.__generator(this, function (e) {
        switch (e.label) {
          case 0:
            ...
            this.Be.runTransaction("shutdown", "readwrite", [Jn.store, hr.store], function (e) {
              var n = new Nr(e, _.o);
  ...
  t.prototype.fn = function () {
    ...
    return this.Be.runTransaction(t, o, dr, function (o) {
      return (i = new Nr(o, r.Ne ? r.Ne.next() : _.o), "readwrite-primary" === e ? r.Je(i).next(function (t) {
        ...
        if (!e) throw (A("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, r.Se.enqueueRetryable(function () {
          return r.Me(!1);
...
(function () {
  ...
  return (t.prototype.Vn = function (t) {
    this.Sn = t;
  ...
  t.prototype.getDocumentsMatchingQuery = function (t, e, n, r) {
    ...
    return (function (t) {
      ...
      var s = i.Cn(e, o);
      return (zt(e) || Wt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (D() <= _firebaseLogger.LogLevel.DEBUG && N("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ne(e)), i.Sn.getDocumentsMatchingQuery(t, e, n).next(function (t) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", function (t) {
    ...
    return n.qe.getTargetData(t, e).next(function (i) {
      ...
      (r = i, mr.resolve(r)) : n.qe.allocateTargetId(t).next(function (i) {
        ...
        t.currentSequenceNumber), n.qe.addTargetData(t, r).next(function () {
          return r;
        }));
      });
    });
...
*/
function Xi(t, e, n) {
  return (void 0 === n && (n = en()), _tslib.__awaiter(this, void 0, void 0, function () {
    var r, i;
    return _tslib.__generator(this, function (o) {
      switch (o.label) {
        case 0:
...
(function () {
  ...
  }, t.prototype.Gt = function (t) {}, t.prototype.containsKey = function (t, e) {
...
(function () {
  ...
  */
  function t(t, e) {
    var n = this;
    (this.gs = {}, this.Ne = new _(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), this.qe = new ro(this), this.Ut = new zr(), this.Ue = (function (t, e) {
  ...
  return (t.prototype.start = function () {
    ...
    enumerable: !1,
    configurable: !0
  }), t.prototype.setDatabaseDeletedListener = function () {}, t.prototype.setNetworkEnabled = function () {}, t.prototype.getIndexManager = function () {
    return this.Ut;
  }, t.prototype.getMutationQueue = function (t) {
...
(function () {
  ...
  }, t.prototype.handleUserChange = function (t, e, n) {}, t.prototype.setOnlineState = function (t) {}, t.prototype.shutdown = function () {}, t.prototype.writeSequenceNumber = function (t) {}, t.prototype.notifyBundleLoaded = function () {}, t);
})(), wo = /** @class*/
(function () {
  function t() {}
  return (t.prototype.di = function (t) {}, t.prototype.shutdown = function () {}, t);
})(), bo = /** @class*/
(function () {
  function t() {
    var t = this;
...
(function (t) {
  ...
  * HTTP).
  */
  return (_tslib.__extends(u, t), u.prototype.ki = function (t, e, n, r) {
    return new Promise(function (i, o) {
      var s = new _firebaseWebchannelWrapper.XhrIo();
      s.listenOnce(_firebaseWebchannelWrapper.EventType.COMPLETE, function () {
        try {
          switch (s.getLastErrorCode()) {
            ...
            case _firebaseWebchannelWrapper.ErrorCode.HTTP_ERROR:
              var n = s.getStatus();
              if ((N("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", s.getResponseText()), n > 0)) {
    ...
    var a = [this.Di, "/", "google.firestore.v1.Firestore", "/", t, "/channel"], c = _firebaseWebchannelWrapper.createWebChannelTransport(), h = _firebaseWebchannelWrapper.getStatEventTarget(), f = {
    ...
    return (_(g, _firebaseWebchannelWrapper.WebChannel.EventType.OPEN, function () {
      b || N("Connection", "WebChannel transport opened.");
    }), _(g, _firebaseWebchannelWrapper.WebChannel.EventType.CLOSE, function () {
      b || (b = !0, N("Connection", "WebChannel transport closed"), I.Vi());
    }), _(g, _firebaseWebchannelWrapper.WebChannel.EventType.ERROR, function (t) {
      b || (b = !0, k("Connection", "WebChannel transport errored:", t), I.Vi(new T(E.UNAVAILABLE, "The operation could not be completed")));
    }), _(g, _firebaseWebchannelWrapper.WebChannel.EventType.MESSAGE, function (t) {
      var e;
      if (!b) {
        var n = t.data[0];
        R(!!n);
    ...
    }), _(h, _firebaseWebchannelWrapper.Event.STAT_EVENT, function (t) {
...
(function () {
  ...
  */
  t.prototype.ji = function (t) {
    ...
    (i > 0 && N("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.qi + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), this.Ui = this.Se.enqueueAfterDelay(this.timerId, i, function () {
...
(function (t) {
  ...
  return (_tslib.__extends(e, t), e.prototype.wr = function (t) {
...
(function (t) {
  ...
  return (_tslib.__extends(e, t), Object.defineProperty(e.prototype, "pr", {
    /**
...
(function (t) {
  ...
  return (_tslib.__extends(e, t), e.prototype.br = function () {
...
(function () {
  ...
  return (t.prototype.track = function (t) {
    ...
    t.type && 1 !== /*Removed*/
    n.type ? this.Kr = this.Kr.insert(e, {
      type: n.type,
      doc: t.doc
    }) : 2 === /*Modified*/
    t.type && 2 === /*Modified*/
    ...
    return _tslib.__awaiter(this, void 0, void 0, function () {
      ...
      return _tslib.__generator(this, function (o) {
        switch (o.label) {
          ...
          case 5:
            return [2, /*return*/
            (this.progress.taskState = "Success", new Ci(Object.assign({}, this.progress), t))];
        }
      });
    });
  }, t);
...
(function () {
  ...
  r, i, o) {
    (this.localStore = t, this.remoteStore = e, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.vo = {}, this.Po = new mi(function (t) {
      return ee(t);
    }, te), this.Vo = new Map(), /**
    ...
    return _tslib.__generator(this, function (o) {
      switch (o.label) {
        case 0:
          ...
          (n.Vo.set(r.targetId, i.filter(function (t) {
            return !te(t, e);
...
function Ys(t) {
  return _tslib.__awaiter(this, void 0, void 0, function () {
    ...
    return _tslib.__generator(this, function (n) {
      return [2, /*return*/
      Wi((e = O(t)).localStore).then(function (t) {
        return Qs(e, t);
      })];
    });
  });
    ...
    return _tslib.__generator(this, function (h) {
      switch (h.label) {
        ...
        case 3:
          ...
          7] : (a = [], c = Promise.resolve(), n.Vo.forEach(function (t, e) {
...
function Js(t, e, n) {
  return _tslib.__awaiter(this, void 0, void 0, function () {
    ...
    return _tslib.__generator(this, function (v) {
      switch (v.label) {
        case 0:
...
(function () {
  ...
  */
  e, n) {
    var r = this;
    (this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = uo.UNAUTHENTICATED, this.clientId = P.u(), this.credentialListener = function () {}, this.receivedInitialUser = new vr(), this.credentials.setChangeListener(function (t) {
...
(function () {
  /** @hideconstructor*/
  function t(t, e) {
    (this._persistenceKey = "(lite)", this._settings = new Ku({}), this._settingsFrozen = !1, t instanceof Au ? (this._databaseId = t, this._credentials = new Cu()) : (this._app = t, this._databaseId = (function (t) {
...
(function (t) {
  ...
  return (_tslib.__extends(e, t), e.prototype._terminate = function () {
...
(function (t) {
  ...
  return (_tslib.__extends(e, t), e.prototype._toFieldTransform = function (t) {
    if (2 !== /*MergeSet*/
    t.Dc) throw 1 === /*Update*/
    t.Dc ? t.$c(this._methodName + "() can only appear at the top level of your update data") : t.$c(this._methodName + "() cannot be used with set() unless you pass {merge:true}");
...
function Aa(t, e) {
  ...
  */
  ...
  return (function (t, e) {
    if (null === (t = _firebaseUtil.getModularInstance(t))) return {
      nullValue: "NULL_VALUE"
    };
...
(function (t) {
  ...
  return (_tslib.__extends(e, t), e.prototype._apply = function (t) {
...
function tc(t, e, n, r) {
  if ((n[0] = _firebaseUtil.getModularInstance(n[0]), n[0] instanceof Fa)) return (function (t, e, n, r, i) {
...
function ec(t, e, n) {
  if ("string" == typeof (n = _firebaseUtil.getModularInstance(n))) {
...
(function (t) {
  ...
  return (_tslib.__extends(e, t), e.prototype.convertBytes = function (t) {
    return new aa(t);
...
(function () {
  ...
  return (Object.defineProperty(t.prototype, "_databaseId", {
    ...
    !(function (t, e, n) {
      ...
      ("firestore.googleapis.com" !== r.host && r.host !== e && k("Host has been set in both settings() and useEmulator(), emulator host will be used"), t._setSettings(Object.assign(Object.assign({}, r), {
        host: e + ":" + n,
        ssl: !1
      })));
    })(this._delegate, t, e);
...
},{"process":"7AgFc","@firebase/util":"3bR6t","@firebase/logger":"5PuYX","@firebase/webchannel-wrapper":"71Sz5","tslib":"4rd38","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"7AgFc":[function(require,module,exports) {
...
},{}]},["1vSbZ","3GZMZ"], "3GZMZ", "parcelRequire4351")
